...
export declare class FormationsService {
    ...
    private dataSource;
    constructor(formationsRepository: Repository<Formation>, formateurRepository: Repository<Formateur>, modulesRepository: Repository<ModuleEntity>, invitationsRepository: Repository<InvitationEntity>, resourcesRepository: Repository<ResourceEntity>, dataSource: DataSource);
